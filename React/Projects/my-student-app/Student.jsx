...
//          enter a roll : <input type="text" name='roll' value={student.roll} onChange={handleChange} required/> <br /><br />
//          entera name : <input type="text" name='name' value={student.name} onChange={handleChange} required/><br></br>
//          enter a math : <input type="text" name='math' value={student.math} onChange={handleChange} required/><br></br>
//          enter a english : <input type="text" name='english' value={student.english} onChange={handleChange} required/><br></br>
//          enter a science : <input type="text" name='science' value={student.science} onChange={handleChange} required/><br></br>
